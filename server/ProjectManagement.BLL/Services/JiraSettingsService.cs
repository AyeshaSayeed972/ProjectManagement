...
public class JiraSettingsService : IJiraSettingsService
{
    ...
    public async System.Threading.Tasks.Task<JiraSettingsDto?> GetAsync()
    {
    ...
    public async System.Threading.Tasks.Task<JiraSettingsDto> UpsertAsync(UpsertJiraSettingsDto dto)
    {
