...
public class UserRepository : IUserRepository
{
    ...
    public async System.Threading.Tasks.Task<(IEnumerable<User> Items, int TotalCount)> GetPagedAsync(int pageNumber, int pageSize)
    {
    ...
    public async System.Threading.Tasks.Task<(IEnumerable<User> Items, int TotalCount)> GetFilteredPagedAsync(int pageNumber, int pageSize, UserRole? role)
    {
