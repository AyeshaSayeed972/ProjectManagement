...
public class TaskRepository : ITaskRepository
{
    ...
    public async System.Threading.Tasks.Task<(IEnumerable<TaskResponseDto> Items, int TotalCount)> GetByReleaseIdPagedAsync(
    ...
    public async System.Threading.Tasks.Task<(IEnumerable<TaskResponseDto> Items, int TotalCount)> GetAllPagedAsync(
